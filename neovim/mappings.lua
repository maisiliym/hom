...
nmap('<leader>kl', '<cmd>lua print(vim.uri_from_bufnr(vim.api.nvim_get_current_buf()))<cr>')
-- start('Miksd')
...
nmap('<leader>fH', [[:lua niovi.telescope.find_files{ search_dirs = {'~/dev',} }<CR>]])
...
nmap("<leader>dr", ":Gina commit --amend --allow-empty-message --opener=split<cr>")
